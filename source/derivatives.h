...
class StateDerivative {
  public:
    ...
    StateDerivative(double vx, double vy, double vz, 
...
class StateVector {
  public:
    ...
    StateVector(double x, double y, double z, 
...
template <typename T>
DynamicStepResult rk45_step(std::function<StateDerivative(double, StateVector, T)> f, 
                            double t, const StateVector &y, double h, 
  ...
  do {
    ...
    auto k3 = h * f(t + a_table[2] * h, y + b_table[2][0] * k1 
                      + b_table[2][1] * k2, cfg);
    auto k4 = h * f(t + a_table[3] * h, y + b_table[3][0] * k1 
                      + b_table[3][1] * k2 + b_table[3][2] * k3, cfg);
    auto k5 = h * f(t + a_table[4] * h, y + b_table[4][0] * k1 
                      + b_table[4][1] * k2 + b_table[4][2] * k3 
                      + b_table[4][3] * k4, cfg);
    auto k6 = h * f(t + a_table[5] * h, y + b_table[5][0] * k1 
                      + b_table[5][1] * k2 + b_table[5][2] * k3 
                      + b_table[5][3] * k4 + b_table[5][4] * k5, cfg);
    y_new = y + ch_table[0] * k1 + ch_table[1] * k2 + ch_table[2] * k3 
              + ch_table[3] * k4 + ch_table[4] * k5 + ch_table[5] * k6;
    truncation_error = abs(ct_table[0] * k1 + ct_table[1] * k2 
                           + ct_table[2] * k3 + ct_table[3] * k4 
                           + ct_table[4] * k5 + ct_table[5] * k6);
